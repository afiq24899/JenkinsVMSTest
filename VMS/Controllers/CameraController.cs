...
namespace Lingkail.VMS.Controllers
{
    ...
    {
        //public static string WebLocation { get; set; }
        ...
        /// <summary>
        /// beginning of rtsp
        /// reference : https://www.thereformedprogrammer.net/asp-net-core-razor-pages-how-to-implement-ajax-requests/
        /// </summary>
        ...
        private static void RtspClient_FrameReceived(object sender, RawFrame rawFrame)
        {
            ...
            if (decodedFrame != null)
            {
                ...
                try
                {
                    ...
                    {
                        // Change to your path
                        mypath = Path.Combine(_hostingEnvironment.WebRootPath, "uploads\\", "1", "image21.jpg");//need escpae character double slash
                    ...
                    {
                        // Change to your path
                        mypath = Path.Combine(_hostingEnvironment.WebRootPath, "uploads/", "1", "image21.jpg");//linux path
                        im.Save(@mypath, ImageFormat.Jpeg);
                        return;
                    }
